// Fix for hero rotation initialization
document.addEventListener('DOMContentLoaded', () => {
    ...
    const slideDuration = 8000; // 5000 milliseconds = 5 seconds
    
    // Make sure we have slides before starting rotation
...
function initializeTestimonialCarousel() {
    ...
    function showTestimonial(index) {
        ...
        // Move the carousel
        const offset = -currentIndex * 100; // Each card is 100% of the carousel width
...
// Initialize the Testimonial Carousel when DOM is loaded
document.addEventListener('DOMContentLoaded', () => {
 ...
 document.addEventListener('DOMContentLoaded', () => {
     ...
     // Fix for loading screen initialization
document.addEventListener("DOMContentLoaded", () => {
